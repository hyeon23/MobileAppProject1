...
class FishFragment : Fragment() {
    ...
    val arrayList = arrayListOf<AnimalData>(
        AnimalData(R.drawable.jara1,"따봉자라","자라","일감호 및 다리 근처 판넬 위", "" +
        ...
        AnimalData(R.drawable.turtle1,"KU북이","거북이","일감호 및 다리 근처 판넬 위", "" +
                "일감호에 사는 거북이의 일종이다.\n" +
                "토종 거북이 남생이로 등갑이 구형으로 동그랗다.\n" +
                "학생들이 종종 따봉자라와 착각한다.\n" +
                "일감호 다리에서 보이는 강 위 나무 판넬 위에서 다른 거북이들과 일광욕을 자주 즐기고 있다.", View.GONE),
        AnimalData(R.drawable.turtle2,"붉은 귀 거북","거북이","일감호 및 다리 근처 판넬 위", "" +
                "일감호에 사는 거북이의 일종\n" +
